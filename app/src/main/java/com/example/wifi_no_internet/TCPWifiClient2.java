...
public class TCPWifiClient2 {
     ...
     */
    TCPWifiClient2(InetAddress pservIF, int pPort){
        this.ServerIP = pservIF;
        this.SocketPort = pPort;
        Log.d("test" + ServerIP, "TCPWifiClient2: ");
    }
...
// Selection of the order to send, depending of what called the TCPClient
        ...
        else if(command.equals("Arg")){order = 0x11;}
        else if(command.equals("Arg2")){order = 0x11;}
        else if(command.equals("Arg3")){order = 0x11;}
        else if(command.equals("Arg4")){order = 0x11;}
