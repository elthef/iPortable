...
public class TCPWifiClient4 {
     ...
     */
    TCPWifiClient4(InetAddress pservIF, int pPort){
...
// Selection of the order to send, depending of what called the TCPClient
        ...
        else if(command.equals("Arg")){order = 0x13;}
        else if(command.equals("Arg2")){order = 0x13;}
        else if(command.equals("Arg3")){order = 0x13;}
        else if(command.equals("Arg4")){order = 0x13;}
